...
def plot_timestack_individual(timestacks, rectification_parameters, data_filtered, processed_timestacks):
    ...
    from matplotlib.ticker import (MultipleLocator, AutoMinorLocator,LogLocator,FuncFormatter,FormatStrFormatter)
    import numpy as np
    import os
    ...
    for t in tnrange(number_timestack, desc = '1st loop'):
        ...
        for time in tnrange(np.shape(processed_timestacks["timestack" + str(t)]["Angular_density"])[1],desc ='2nd loop', leave = True):
