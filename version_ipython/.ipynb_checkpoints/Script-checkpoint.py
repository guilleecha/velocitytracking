...
script_folder = Path()
sys.path.append('/Users/guille/Dropbox/Maestria/002 - Scripts/Version_JupyterNotebook')
%matplotlib notebook
%matplotlib notebook
...
#            video = video_path + '/' + video_name
            ...
            data_filtered = timestack_filter(processed_timestacks,rectification_parameters,threshold=1e6)
            pass
        elif option == '9':
